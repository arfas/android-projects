...
public class UserCancel extends Activity {
	...
	String[] status1 = { "Select Status", "Available", "Not Available" };
	DBHelper brdb;
	SharedPreferences sp;
	String myselectedbloodgroup, myselecteddistrict;
	SQLiteDatabase db;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> mybloodgroup = new ArrayAdapter<String>(UserCancel.this,
				android.R.layout.simple_dropdown_item_1line, groups);
		bloodgrp.setAdapter(mybloodgroup);
		ArrayAdapter<String> mybloodstatus = new ArrayAdapter<String>(UserCancel.this,
		...
		bloodgrp.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
				// TODO Auto-generated method stub
				myselectedbloodgroup = groups[position];
			}
		...
		ArrayAdapter<String> mydistrict = new ArrayAdapter<String>(UserCancel.this,
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!TextUtils.isEmpty(name.getText().toString()) && !TextUtils.isEmpty(phno.getText().toString())
					...
					cv.put("donar_id", sp.getInt("donar_id", 0));
					...
					cv.put("bbg", myselectedbloodgroup);
					cv.put("bdistrict", myselecteddistrict);

					cv.put("bstatus", status.getSelectedItem().toString());
					cv.put("blod", setldod.getText().toString());
					db.insert("Donar", null, cv);

					finish();
					Toast.makeText(UserCancel.this, "Successfully Requested for CANCEL", Toast.LENGTH_LONG).show();
				} else {
					Toast.makeText(UserCancel.this, "Your field should not be empty", Toast.LENGTH_LONG).show();
				}
